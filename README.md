...
<div align="center">
  ...
  <a href="https://open.spotify.com/user/315p554yeqawff6qlol2mtdc7tfm" target="_blank">
    <img src="https://img.shields.io/badge/Spotify-1DB954?style=for-the-badge&logo=spotify&logoColor=white" />
  </a>
  <br/><br/>
  <img src="https://komarev.com/ghpvc/?username=HenriqueMC17&label=Profile+Views&color=7C3AED&style=for-the-badge" />
</div>
...
const HenriqueMC17 = {
  ...
  expertise: {
    backend:      ["Node.js", "Java", "Python", "REST APIs", "Microservices"],
    frontend:     ["React", "Next.js", "TypeScript", "Angular", "UI/UX Premium"],
    cloud:        ["GCP", "Docker", "CI/CD", "Event-Driven Architecture"],
    ai:           ["Agentic Workflows", "LLM Integration", "Context Engineering"],
  },

  principles: ["Clean Code", "TDD", "DDD", "SOLID", "Zero Entropy"],
  currentlyBuilding: "AI-First enterprise systems with autonomous agent governance",
};
```

> **"A arquitetura de software é o compromisso que molda a velocidade de entrega, segurança e viabilidade econômica de um produto a longo prazo."**
...
| 🏗️ Arquitetura & Backend | 🖥️ Frontend & UX | ☁️ Cloud & DevOps | 🤖 AI Engineering |
|:---:|:---:|:---:|:---:|
| APIs RESTful & GraphQL | React / Next.js App Router | GCP / Firebase | Agentic Workflows |
| Microservices & Event-Driven | TypeScript Avançado | Docker & CI/CD | LLM Orchestration |
| Clean Architecture & DDD | Design Systems Premium | Observabilidade | Context Engineering |
| Node.js / Java / Python | Performance & Core Web Vitals | IaC & Automação | AI-Assisted Dev |
...
| Competência AI | Nível |
|:---|:---:|
| Agentic Workflows & SALLMA Orchestration | ████████░░ Advanced |
| Context Engineering & LLMOps | ████████░░ Advanced |
| COVE (Chain-of-Verification) | ███████░░░ Proficient |
| AI-Assisted Code Review & Governance | ████████░░ Advanced |
| Prompt Engineering 2.0 (XML-structured) | █████████░ Expert |
    ...
    <tr>
      <td align="center" width="50%">
        <a href="https://v0-saas-landing-page-bi83mscdt.vercel.app/" target="_blank">
          <img src="https://img.shields.io/badge/🏦_Safe_Finance_SaaS-00F7E0?style=for-the-badge&logoColor=black" />
        </a><br/><br/>
        <b>Plataforma de Gestão Financeira</b><br/>
        <i>SaaS com arquitetura front-end escalável, performance otimizada<br/>para Core Web Vitals e UI/UX de nível enterprise.</i><br/><br/>
        <img src="https://skillicons.dev/icons?i=react,ts,tailwind,vercel" height="28"/>
      </td>
      <td align="center" width="50%">
        <a href="https://v0-portfolio-website-zeta-plum.vercel.app/" target="_blank">
          <img src="https://img.shields.io/badge/🎨_Personal_Portfolio-7C3AED?style=for-the-badge&logoColor=white" />
        </a><br/><br/>
        <b>Engine de Rendering & Design System</b><br/>
        <i>Ecossistema moderno com SSR/SSG, Design System customizado,<br/>animações premium e deploy automatizado.</i><br/><br/>
        <img src="https://skillicons.dev/icons?i=nextjs,react,ts,tailwind" height="28"/>
      </td>
    </tr>
    <tr>
      <td align="center" width="50%">
        <a href="https://github.com/HenriqueMC17/JogoDaVelha" target="_blank">
          <img src="https://img.shields.io/badge/🎮_Tic_Tac_Toe_Engine-FF5722?style=for-the-badge&logoColor=white" />
        </a><br/><br/>
        <b>State Machine & Game Logic</b><br/>
        <i>Implementação de algoritmos de estado interativo,<br/>gestão de state global e DOM manipulation pura.</i><br/><br/>
      ...
      <td align="center" width="50%">
        <a href="https://github.com/HenriqueMC17/OrganizadorDeArquivos" target="_blank">
          <img src="https://img.shields.io/badge/📁_File_System_Organizer-3776AB?style=for-the-badge&logoColor=white" />
        </a><br/><br/>
        <b>Ferramenta de Automação de Infraestrutura</b><br/>
        <i>Scripting inteligente em Python para gerenciamento<br/>I/O eficiente e padronização de diretórios.</i><br/><br/>
        <img src="https://skillicons.dev/icons?i=py" height="28"/>
      </td>
    </tr>
  </table>
</div>
